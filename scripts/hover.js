document.addEventListener('DOMContentLoaded', async () => {
	...
	const translations = {
		en: {
			...
			'tippspiel.copy': 'Join our Kicktipp World Cup giveaway with great prizes. Main prize: a match-worn FCN jersey.',
		...
		de: {
			...
			'tippspiel.copy': 'Mach mit bei unserem Kicktipp-Gewinnspiel zur WM mit tollen Preisen. Hauptpreis: ein matchworn FCN-Trikot.',
